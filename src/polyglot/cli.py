"""Command-line interface for Polyglot."""
...
from polyglot.analysis.analyzer import FileAnalysisResult, PickleAnalyzer


def _report_to_dict(report: object) -> dict:
    from polyglot.analysis.analyzer import AnalysisReport
