...
from polyglot.analysis.cfg_taint import CfgTaintResult, ExploitPath, propagate_cfg_taint
from polyglot.domain.cfg import CFG, EdgeKind, NodeKind
...
from polyglot.formats.loader import FileFormat, LoadedFile, load_file
...
class PickleAnalyzer:
    ...
    def __init__(self, emulator: PvmEmulator | None = None) -> None:
